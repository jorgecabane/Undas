...
<html>
    ...
    <body background="images/bg.gif">
      ...
      <form action='agregarCentroNuevo.php' method='POST'>
        <div class="form-group">
          <label for="nombre" >Nombre</label>
          <input type="text" class="form-control" name="nombre" placeholder="Agrege nombre">
        </div>
         <div class="form-group">
          <label for="siglas">Siglas</label>
          <input type="text" class="form-control" name="siglas" placeholder="Agrege siglas">
        </div>
          </br>
