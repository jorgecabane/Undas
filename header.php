            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    if (isset($_SESSION['super'])) {
                        ...
                        echo '<li><a href="bugReport.php" ><font color="red">¡Envíanos tu Feeback!</font></a></li>';
                        echo '<li><a href="editarClave.php">Editar Clave</a></li>';
                    }
                    ?>
                    <li>
                        <button onClick="window.location.href = 'logOff.php'" class="btn btn-danger navbar-btn">
                            <strong class=""><?php echo $_SESSION['usuario']; ?></strong> (Cerrar sesión)
                        </button>
                    </li>
                </ul>
