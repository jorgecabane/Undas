...
<html>
  ...
  <body background="images/bg.gif">
    <div class="container">
      ...
      <form role="form" action="querys/insertDatosMensualesR.php" method="POST">
...
include_once "conexionLocal.php";
    ...
    $resultado = mysql_query($query) or die(mysql_error());
    if ($resultado) {
        echo"<select required name='centro' id='centro'>";
 echo "<option value=''> Seleccione Centro </option>";
  ...
  <option value="12">Diciembre</option>
          ...
          <select required class="form-control"  name="año">
  ...
  <option value="2025">2025</option>
         ...
         <div class="form-group">
          ...
          <input type="number" class="form-control" name="CantidadCupos" placeholder="Numero de cupos" required>
        </div>                  
