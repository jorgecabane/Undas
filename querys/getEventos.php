...
function getEventos($idCentro = null) {
	if ($idCentro != null) {
		$query = "SELECT Ecos.Nombre as title, concat(TM.Nombre,' ' ,TM.Apellido) as description, idEvento as id, HoraInicio as start, HoraTermino as end, color, idEcos as idEco
				FROM Evento, Ecos, TM
