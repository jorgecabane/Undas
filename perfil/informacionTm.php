					...
					<tr>
						<td>
							<div class="form-group">
								<input type="text" class="form-control editable" name="Nombre"
						...
						<td>
							<div class="form-group"> 
								<input type="text" class="form-control editable" name="Apellido"
						...
						<td>
							<div class="form-group">
								<input type="number" class="form-control editable" name="Rut"
						...
						<td>
							<div class="form-group">
								<input type="text" class="form-control editable" name="Mail"
						...
						<td>
							<div class="form-group">
								<input type="number" class="form-control editable" name="Celular"
